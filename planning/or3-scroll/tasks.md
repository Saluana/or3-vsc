...
-   [ ] **1.1 Bootstrap project structure** (Req: R1, R2)
...
-   [ ] **1.2 Build tooling + scripts** (Req: R8, Non-func Packaging)
...
-   [ ] **3.1 Base template + props** (Req: R2, R8)
...
-   [ ] **3.2 Scroll state composable** (Req: R2, R3)
...
-   [ ] **3.3 Virtual slice renderer** (Req: R1, R5)
...
-   [ ] **4.1 Shared ResizeObserver** (Req: R4, R5)
...
-   [ ] **4.2 Scroll compensation logic** (Req: R5)
...
-   [ ] **4.3 Hidden measurement pool** (Req: R6)
...
-   [ ] **5.1 Bottom anchoring + follow state machine** (Req: R3, R4)
...
-   [ ] **5.3 History prepend lifecycle** (Req: R6)
...
-   [ ] **6.1 Exposed methods + key lookups** (Req: R8)
...
-   [ ] **8.1 Build artifacts + type declarations** (Req: Non-func Packaging)
