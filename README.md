...
| `restoreScrollState`  | `(state)`                                                                                       | Restores a same-content memento, preferring a keyed anchor and falling back to its clamped offset when no saved row is available. Restoration cancels stale jumps and bottom placement. |
